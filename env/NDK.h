...
typedef enum {
	...
	NDK_ERR_MODEM_INIT_NOT = -501,			/**<MODEM 未进行初始化*/
	NDK_ERR_MODEM_RESETFAIL = -502,			/**<MODEM 复位失败*/
	NDK_ERR_MODEM_SLEPPFAIL = -503,			/**<MODEM 休眠失败*/
	NDK_ERR_MODEM_SDLCINITFAIL = -504,		/**<MODEM 同步初始化失败*/
	NDK_ERR_MODEM_SDLCDIALFAIL = -505,		/**<MODEM 同步拨号失败*/
	NDK_ERR_MODEM_SDLCWRITEFAIL = -506,		/**<MODEM 同步写数据冲失败*/	
	NDK_ERR_MODEM_SDLCCLRBUFFAIL=-507,		/**<MODEM 同步清缓冲失败*/		
	NDK_ERR_MODEM_SDLCHANGUPFAIL = -508,	/**<MODEM 同步挂断失败*/
	NDK_ERR_MODEM_ASYNINITFAIL = -509,		/**<MODEM 异步初始化失败*/	
	NDK_ERR_MODEM_ASYNDIALFAIL = -510,		/**<MODEM 异步拨号失败*/
	NDK_ERR_MODEM_ASYNWRITEFAIL = -511,		/**<MODEM 异步写数据失败*/
	NDK_ERR_MODEM_ASYNCLRBUFFAIL = -512,	/**<MODEM 异步清缓冲失败*/	
	NDK_ERR_MODEM_ASYNHANGUPFAIL = -513,	/**<MODEM 异步挂断失败*/		
	NDK_ERR_MODEM_ATCOMNORESPONSE = -514, 	/**<MODEM AT命令无响应*/
	NDK_ERR_MODEM_GETSTATUSFAIL = -514,		/**<MODEM 获取状态失败*/
	NDK_ERR_MODEM_NOLINE = -516,			/**<MODEM 未插线*/
	NDK_ERR_MODEM_OTHERMACHINE = -517,		/**<MODEM 存在并机*/
	NDK_ERR_MODEM_GETVERFAIL = -518,		/**<MODEM获取版本失败*/
	NDK_ERR_MODEM_GETBUFFLENFAIL = -519,	/**<MODEM获取数据长度失败*/
...
typedef struct __POWERINFO {
    ...
    int unPowerType;  /*电源类型
        ...
        0xff表示未知)*/
    uchar unBattryPercent;/*电池电量百分比（插电源时电压百分比为0，0xff表示未知）*/
} ST_POWER_INFO;
